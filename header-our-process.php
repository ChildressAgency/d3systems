    ...
    <div class="container">
      <div class="navbar-header">
        <a href="<?php echo home_url(); ?>" class="header-logo">
          <img src="<?php echo echo get_field('header_logo', 'option') ? get_field('header_logo', 'option') : get_stylesheet_directory_uri() . '/images/logo.png'; ?>" class="img-responsive" alt="D3 Systems Logo" />
        </a>
