      ...
      <div class="row">
        <div class="col-sm-4">
          ...
          <ul class="list-unstyled">
            <li>Research: <a href="<?php echo add_query_arg('subject', 1, home_url('contact')); ?>" class="value"><?php the_field('research_email', 'option'); ?></a></li>
            <li>Recruitment: <a href="<?php echo add_query_arg('subject', 3, home_url('contact')); ?>" class="value"><?php the_field('recruitment_email', 'option'); ?></a></li>
            <li>General: <a href="<?php echo add_query_arg('subject', 2, home_url('contact')); ?>" class="value"><?php the_field('general_email', 'option'); ?></a></li>
          </ul>
          <p>
